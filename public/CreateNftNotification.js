const secondSlide = `<div class="topBar">
    ...
    <div class="main">
        ...
        <div class="middle">
            ...
            <div>
                <div></div>
                <p>Creating a new NFT named: <b id="name"></b></p>
            </div>
        </div>
...
function CreateLogicFunction() {
    if (CurrentSlide === 1) {
        ...
        const nftNameText = document.getElementById("name");
